...
import { ProfilEntreprise } from './entreprise/home/profil-entreprise/profil-entreprise';
...
export const routes: Routes = [
  ...
  // ── Admin ────────────────────────────────────────────
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./admin/home_admin/comonent_admin/gestion_entreprise/gestion_entreprise').then(
            (m) => m.GestionEntrepriseComponent
          ),
      },
    ],
  },
  ...
  { path: 'entreprise/reset-password', component: ResetPasswordComponent2 },
  {
    ...
    children: [
      ...
      { path: 'profil', component: ProfilEntreprise },
    ],
  },
];